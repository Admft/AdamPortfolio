...
This repository still uses React Scripts 5 / Create React App and has inherited dependency audit findings. The build may report the pre-existing missing MediaPipe source map. Address the dependency baseline before describing a public release as fully security-audited. No deployment is performed by this overhaul.
